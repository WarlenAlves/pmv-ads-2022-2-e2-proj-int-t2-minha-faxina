...
if($quantidade > 1) {
     ...
     $result_usuario = "INSERT INTO usuarios_faxi (criado, modificado, nome, email, cpf, idade, cep, rua, numero, complemento, bairro, cidade, senha) VALUES (NOW(), NOW(), '$nome', '$email', '$cpf', '$idade', '$cep', 
     ...
     header("Location: /faxina/index.html");
          ...
          header("Location: /faxina/cadastro/cadsatro-faxi.html");
     }
}